...
if __name__ == "__main__":
	...
	seedList = [['good', 1],['bad', -1],['right',1],['wrong',-1],['love',1],['hate',-1]]
	graph=nx.Graph()
	adjList= []
	...
	plt.savefig("RnWalkWN.png", dpi=400)
	...
	for w in unknown:
		...
		if pos_htime<neg_htime:
			seedList.append([w,round(1/pos_htime,2)])
			splus.append(w)
		elif neg_htime<pos_htime:
			seedList.append([w,round(-1/neg_htime,2)])
			sminus.append(w)
		else:
			seedList.append([w,0])
